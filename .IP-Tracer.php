...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mAuthor \033[01;37m:- \033[01;36mØSC4R O’4S1S
...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/oscar-oasis/IP-TRACER.git");
  system("cd ~/ && sudo git clone https://github.com/oscar-oasis/IP-TRACER.git");
